  ...
  return (
    <>
      <div className='w-full h-[90%] text-white lg:bg-red-700 md:bg-blue-900 sm:bg-slate-800lg:container mx-auto Home__Section__Style overflow-hidden'>
        ...
        <motion.div initial={{y:1000}} animate={{y:0}} transition={{duration:.6  , delay:.4}} className='text text-white flex flex-col justify-center items-center h-full w-[100%] px-5 sm:px-0 mt-[-100px] sm:mt-0'>
          <HomePageContentSec />
        </motion.div>
